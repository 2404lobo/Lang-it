...
<header>
    ...
    <nav class="navbar navbar-expand-sm fixed-top navbar-light" style="background-color: #f7b32b">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item disabled">
                    <a class="nav-link" href="{{ route('home') }}">Translations<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
